...
<header class="bgimg w3-display-container w3-grayscale-min" id="home">
    ...
    <div class="w3-display-middle w3-center">
        <span class="w3-text-white w3-hide-small" style="font-size:90px; text-shadow: 1px 1px 0 black"><b>vis-à-vis</b></span>
        <span class="w3-text-white w3-hide-medium w3-hide-large" style="font-size:35px; text-shadow: 1px 1px 0 black"><b>vis-à-vis</b></span>
        <h3 class="w3-text-white w3-hide-small" style="text-shadow: 1px 1px 0 black;"><em>Making Connections</em></h3>
        <h3 class="w3-text-white w3-hide-large w3-hide-medium" style="font-size:15px; shadow: 1px 1px 0 black;"><em>Making Connections</em></h3>

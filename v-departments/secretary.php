...
<div class="w3-container w3-half">
    ...
    <div class="w3-content w3-padding-64 w3-center v-dept-content" style="max-width:700px" id="info">
        <h4 class="w3-center"><span class="w3-tag w3-wide w3-theme-l1">SECRETARY</span></h4>
        <p class="w3-center w3-large">Support and Official Tasks</p>
        <img class="w3-image" src="../img/dept/Sec.jpg" width="75%">
        <br><br>
        <p class="w3-left-align">The Secretary department handles all integral paperwork needed for the organisation
            to function. In addition to handling official documents, we also maintain internal communication between
            staff. Our routine work includes staff information collection, dissemination, email-writing, meeting
            agenda arrangement, and meeting minutes keeping. We also redact the organisation's annual report.</p>
    </div>
    ...
    <div class="w3-content w3-padding-64 v-dept-content w3-center" id="struc" style="display:none">
        ...
        <h6 class="w3-left-align"><b>Managers:</b> Antone</h6>
    </div>

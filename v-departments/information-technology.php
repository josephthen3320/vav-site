...
<div class="w3-container w3-half">
    ...
    <div class="w3-content w3-padding-64 w3-center v-dept-content" style="max-width:700px" id="info">
        <h4 class="w3-center"><span class="w3-tag w3-wide w3-theme-l1">INFORMATION TECHNOLOGY</span></h4>
        <p class="w3-center w3-large">Technological Assistance and Quality Design</p>
        <img class="w3-image" src="../img/dept/IT.jpg" width="75%">
        <br><br>
        <p class="w3-left-align">The Information Technology department - or IT for short - works closely with all other
            VAV departments to provide timely and necessary technological assistances. We also provide quality graphic
            designs and videos to assist in the organisation's promotion. Our main tasks consist of computer-aided
            design works and media production.</p>
    </div>
    ...
    <div class="w3-content w3-padding-64 v-dept-content w3-center" id="struc" style="display:none">
        ...
        <h6 class="w3-left-align"><b>Managers:</b> Yuki and Iris</h6>
    </div>

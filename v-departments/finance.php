...
<div class="w3-container w3-half">
    ...
    <div class="w3-content w3-padding-64 w3-center v-dept-content" style="max-width:700px" id="info">
        <h4 class="w3-center"><span class="w3-tag w3-wide w3-theme-l1">FINANCE</span></h4>
        <p class="w3-center w3-large">Financial and Resources Management</p>
        <img class="w3-image" src="../img/dept/Fin.jpg" width="75%">
        <br><br>
        <p class="w3-left-align">The Finance department is responsible for the organization's financial situation and
        allocation of resources. We manage the expenditure of each programme and their activities. In addition, we also
        oversee the implementation of budget, audit, reimbursement, and procurement.</p>
        <p class="w3-left-align">We aim to standardise and institutionalise financial and resource management.</p>
    </div>
    ...
    <div class="w3-content w3-padding-64 v-dept-content w3-center" id="struc" style="display:none">
        ...
        <h6 class="w3-left-align"><b>Manager:</b> Lydia</h6>
    </div>

<!DOCTYPE html>
<html>
<title>V-Dept: Human Resources</title>
<meta charset="UTF-8">
...
<div class="w3-container w3-half">
    ...
    <div class="w3-content w3-padding-64 w3-center v-dept-content" style="max-width:700px" id="info">
        <h4 class="w3-center"><span class="w3-tag w3-wide w3-theme-l1">HUMAN RESOURCES</span></h4>
        <p class="w3-center w3-large">Efficiency and Internal Cohesion</p>
        <img class="w3-image" src="../img/dept/HR.jpg" width="75%">
        <br><br>
        <p class="w3-left-align">The Human Resources department arranges major VAV events such as new staff recruitments,
            I-Week leaders recruitments, team building, and annual elections. We are also responsible for assessing
            each staff's and project's performance. To support our goal, we organise regular trainings, workshops, and
            annual meetings for all VAV staff.</p>
    </div>
    ...
    <div class="w3-content w3-padding-64 v-dept-content w3-center" id="struc" style="display:none">
        ...
        <h6 class="w3-left-align"><b>Manager:</b> Oscar</h6>
    </div>

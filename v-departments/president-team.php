<!DOCTYPE html>
<html>
<title>V-Dept: President Team</title>
<meta charset="UTF-8">
...
<div class="w3-container w3-half">
    ...
    <div class="w3-content w3-padding-64 w3-center v-dept-content" style="max-width:700px" id="info">
        <h4 class="w3-center"><span class="w3-tag w3-wide w3-theme-l1">PRESIDENT TEAM</span></h4>
        <p class="w3-center w3-large">Overseeing the Organization</p>
        <img class="w3-image" src="../img/dept/Pres.jpg" width="75%">
        <br><br>
        <p class="w3-left-align">The President Team sets policies and strategic direction for the organisation - both
            short and long term goals. We are responsible to ensure that the organisation follows our mission, policies,
            and procedures. We also evaluate the organisation's performance regularly by being directly involved with
            the various projects and activities organised by organisation.</p>
    </div>
    ...
    <div class="w3-content w3-padding-64 v-dept-content w3-center" id="struc" style="display:none">
        ...
        <h6 class="w3-left-align"><b>President: </b> Henry</h6>
        <h6 class="w3-left-align"><b>Vice-Presidents: </b> Lucie, Sam, and Maggie</h6>
    </div>
...
<div class="w3-container w3-quarter w3-padding-64">
    <div class="w3-bar-block w3-theme">
        <a href="marketing.php" class="w3-bar-item w3-button">
            <h6>Marketing | MKT</h6>
        </a>

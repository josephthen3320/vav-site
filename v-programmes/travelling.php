...
<!-- Content -->
    ...
    <div class="w3-container w3-half">
        ...
        <div class="w3-content w3-padding-64 w3-center v-prog-content" style="max-width:700px" id="info">
            <h4 class="w3-center"><span class="w3-tag w3-wide w3-theme-l1">TRAVELLING</span></h4>
            <p class="w3-center w3-large">Discovering China's Beauty</p>
            <img class="w3-image" src="../img/progs/Tra.jpg" width="75%">
            <br><br>
            <p class="w3-left-align">Travelling programme has offered various opportunities for both domestic and
            international students to have wonderful trips to many of China's most favorite locations, such as Hangzhou,
            Huangshan, Nanjing, and Wuzhen. We are continuously expanding our programme to open more routes to other
            location options.</p>
        </div>
        ...
        <div class="w3-content w3-padding-64 v-prog-content w3-center" id="struc" style="display:none">
            ...
            <h6 class="w3-left-align"><b>Managers:</b> Lilian</h6>
        </div>
    ...
    <div class="w3-container w3-quarter w3-padding-64">
        <div class="w3-bar-block w3-theme">
            ...
            <a href="travelling.php" class="w3-bar-item w3-button w3-theme-l3">

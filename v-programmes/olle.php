...
<!-- Content -->
    ...
    <div class="w3-container w3-half">
        ...
        <div class="w3-content w3-padding-64 w3-center v-prog-content" style="max-width:700px" id="info">
            <h4 class="w3-center"><span class="w3-tag w3-wide w3-theme-l1">OLLE</span></h4>
            <p class="w3-center w3-large">Online Language Learning through Peer Support</p>
            <img class="w3-image" src="../img/progs/OLLE.jpg" width="75%">
            <br><br>
            <p class="w3-left-align">OLLE programme was established in order to support the interest for foreign language
            learning. We work closely with the Language Centre of UNNC an operates in all three Nottingham's campuses.
            We provide opportunities for people from various countries and language backgrounds to be study partners and
            communicate their language learning experiences through online platform. Participants also will have
            opportunities to form inter-campus partnerships.</p>
        </div>
        ...
        <div class="w3-content w3-padding-64 v-prog-content w3-center" id="struc" style="display:none">
            ...
            <h6 class="w3-left-align"><b>Managers:</b> Clara</h6>
        </div>
    ...
    <div class="w3-container w3-quarter w3-padding-64">
        <div class="w3-bar-block w3-theme">
            ...
            <a href="olle.php" class="w3-bar-item w3-button w3-theme-l3">

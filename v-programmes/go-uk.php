...
<!-- Content -->
    ...
    <div class="w3-container w3-half">
        ...
        <div class="w3-content w3-padding-64 w3-center v-prog-content" style="max-width:700px" id="info">
            <h4 class="w3-center"><span class="w3-tag w3-wide w3-theme-l1">GO~UK!</span></h4>
            <p class="w3-center w3-large">Supporting your Exchange Experience</p>
            <img class="w3-image" src="../img/progs/GoUK.jpg" width="75%">
            <br><br>
            <p class="w3-left-align">Go~UK! programme provides a platform for all students - incoming and outgoing -
            who are interested in the exchange programme. We devote ourselves to helping and resolving the confusions
            that students may encounter before their exchange years begin by giving information that may be helpful and
            providing opportunities to communicate with excellent senior exchange students and mentors from different
            countries.</p>
        </div>
        ...
        <div class="w3-content w3-padding-64 v-prog-content w3-center" id="struc" style="display:none">
            ...
            <h6 class="w3-left-align"><b>Managers:</b> Wendy</h6>
        </div>
    ...
    <div class="w3-container w3-quarter w3-padding-64">
        <div class="w3-bar-block w3-theme">
            ...
            <a href="go-uk.php" class="w3-bar-item w3-button w3-theme-l3">
                <h6>Go~UK!</h6>
            </a>

<!DOCTYPE html>
<html>
<title>V-Prog: Buddy System</title>
<meta charset="UTF-8">
...
<!-- Content -->
    ...
    <div class="w3-container w3-half">
        ...
        <div class="w3-content w3-padding-64 w3-center v-prog-content" style="max-width:700px" id="info">
            <h4 class="w3-center"><span class="w3-tag w3-wide w3-theme-l1">BUDDY SYSTEM</span></h4>
            <p class="w3-center w3-large">Friendship without borders</p>
            <img class="w3-image" src="../img/progs/BS.png" width="75%">
            <br><br>
            <p class="w3-left-align">Buddy System programme provides a platform for partnership between international
            and domestic students. We help international students to get acclimatized to the new environment by
            partnering them with domestic students, who in turn will have many opportunities to make international
            friends. We also organises various fun activities for all students in which we can all have fun!</p>
        </div>
        ...
        <div class="w3-content w3-padding-64 v-prog-content w3-center" id="struc" style="display:none">
            ...
            <h6 class="w3-left-align"><b>Managers:</b> Smile</h6>
        </div>
    ...
    <div class="w3-container w3-quarter w3-padding-64">
        <div class="w3-bar-block w3-theme">
            <a href="buddy-system.php" class="w3-bar-item w3-button w3-theme-l3">

...
<!-- Content -->
    ...
    <div class="w3-container w3-half">
        ...
        <div class="w3-content w3-padding-64 w3-center v-prog-content" style="max-width:700px" id="info">
            <h4 class="w3-center"><span class="w3-tag w3-wide w3-theme-l1">PACT</span></h4>
            <p class="w3-center w3-large">Developing English skill through Senior-Freshmen Partnership</p>
            <img class="w3-image" src="../img/progs/PACT.jpg" width="75%">
            <br><br>
            <p class="w3-left-align">PACT programme is a senior-freshman partnership with the shared goal of supporting
            the development of students' oral English skill, independent study skills, and creating friendship across
            the campus. We work closely with CELE (Centre for English Language Education) to organise various student-
            led activities that will benefit students in their journey to adapt to the new English-speaking environment.</p>
        </div>
        ...
        <div class="w3-content w3-padding-64 v-prog-content w3-center" id="struc" style="display:none">
            ...
            <h6 class="w3-left-align"><b>Managers:</b> Mia</h6>
        </div>
    ...
    <div class="w3-container w3-quarter w3-padding-64">
        <div class="w3-bar-block w3-theme">
            ...
            <a href="pact.php" class="w3-bar-item w3-button w3-theme-l3">
